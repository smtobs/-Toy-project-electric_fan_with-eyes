...
IFUPDOWN_SCRIPTS_WIFI_IFACE = 'wlan0'
...
define IFUPDOWN_SCRIPTS_DHCP
	( \
		...
		echo ; \
		echo "auto $(IFUPDOWN_SCRIPTS_WIFI_IFACE)"; \
		echo "iface $(IFUPDOWN_SCRIPTS_WIFI_IFACE) inet dhcp"; \
		echo "  pre-up wpa_supplicant -D nl80211 -i $(IFUPDOWN_SCRIPTS_WIFI_IFACE) -c /etc/wpa_supplicant.conf -B"; \
